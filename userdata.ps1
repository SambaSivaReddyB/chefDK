<powershell>
 ...
 $env:CHEF_SERVER_NAME = "Samba-Chef-AutomateServer-oregon" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "samba-chef-automateserver-oregon-in4tj9xj3v9ncnne.us-west-2.opsworks-cm.io" # FQDN of your Chef Server
 $env:REGION = "us-west-2" # Region of Chef Server (us-east-1, us-west-1 or eu-west-1)
