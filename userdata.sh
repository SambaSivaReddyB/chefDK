...
REGION="us-west-2" # use one of us-east-1, us-west-2, eu-west-1
CHEF_SERVER_NAME="Samba-Chef-AutomateServer-oregon" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="samba-chef-automateserver-oregon-in4tj9xj3v9ncnne.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
...
CHEF_CLIENT_VERSION="13.6.4" # latest if empty
